...
public class InventarioTienda extends javax.swing.JFrame {
    ...
    /**
     * Creates new form InventarioTienda
     */
    ...
    private void btnagregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnagregarActionPerformed
        // Estas son las variables exactas de tu método agregarProducto()
        ...
        if (cantidadProductos < CANTIDAD_MAXIMA) {
            // Jalamos los datos de tus TextFields
            codigoProducto = txtCodigo.getText();

            // TU LÓGICA: Ciclo para ver si el código ya existe
            ...
            if (codigoExiste) {
                ...
                if (precioProducto <= 0) {
                    ...
                    if (cantidadStock <= 0) {
                        ...
                        // TU LÓGICA: Guardar en los arreglos paralelos
        ...
        if (cantidadProductos > 0) {
            ...
            if (productoEncontrado) {
                ...
                if (confirmacion == javax.swing.JOptionPane.YES_OPTION) {
                    // TU LÓGICA: Correr los datos en los arreglos para eliminar
    ...
    private void btnReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReporteActionPerformed
        try {
            ...
            if (cantidadProductos > 0) {
                ...
                // TU LÓGICA: Ciclo para llenar la tabla HTML
                for (int i = 0; i < cantidadProductos; i++) {
    ...
    private void btnVentasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVentasActionPerformed
        ...
        if (productoEncontrado) {
            ...
            if (cantidadAVender <= stocks[indiceVender]) {
                // TU LÓGICA: Descontar stock y registrar venta
    ...
    private void btnVerVentasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerVentasActionPerformed
        ...
        if (cantidadProductos > 0) {
            // TU LÓGICA: Buscar el producto por código
            for (int i = 0; i < cantidadProductos; i++) {
            ...
            if (productoEncontrado) {
                if (cantidad > 0) {
                    if (cantidad <= stocks[indiceVender]) {
                        // TU LÓGICA: Descontar y calcular total
